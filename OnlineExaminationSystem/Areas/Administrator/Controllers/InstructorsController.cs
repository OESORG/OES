...
namespace OnlineExaminationSystem.Areas.Administrator.Controllers
{
    ...
    public class InstructorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,UserName,Name,Password,Email,Role,Code")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserName,Name,Password,Email")] Instructor instructor)
        {
            if (ModelState.IsValid)
            {
